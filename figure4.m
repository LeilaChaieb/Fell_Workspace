...
%novelty
datasetsFam={'LAH3','LPHC2','LPHC2','LPHC2','RAH4','REC2','REC4','RPHC4'};
clusterFam=[4,1,2,11,11,7,7,1];
...
RPs=[-1*Rp RpF]-[-1*allNew allNewF]; RMs=([-1*Rm RmF])-([-1*allNew allNewF]); FN=([-1*miss missF])-([-1*allNew allNewF]); FP=([-1*fa faF])-([-1*allNew allNewF]); TN=([-1*new newF])-([-1*allNew allNewF]);
