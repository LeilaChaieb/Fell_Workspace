...
resultStim=instantaneousFiringPre(datasets,condition,code1,group);
...
group='novelty or familiarity';

resultNov=instantaneousFiring(datasets,condition,code1,code2,group);
...
resultItem=instantaneousFiring(datasets,condition,code1,code2,group);
...
resultSource=instantaneousFiring(datasets,condition,code1,code2,group);
...
code1=[1,2,3,4,5,6];
datasets={'A-10','EC-1'};
group='beat stimulation';

resultBeat=instantaneousFiringBeat(datasets,condition1,condition2,condition3,code1,group);
...
resultColor=instantaneousFiringAssociation(datasets,condition,code,source,group);
